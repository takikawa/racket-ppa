/* scheme.h for Chez Scheme Version 9.5.7.6 (pb) */
...
EXPORT ptr Sforeign_callable_code_object PROTO((void*));
...
EXPORT void Sregister_pbchunks PROTO((void **, int, int));
