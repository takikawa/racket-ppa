This is the PLT Scheme v4.1.1 source package directory for Unix.

You must compile MzScheme and MrEd before using the PLT Scheme software
(including DrScheme).

For compilation instructions, see "plt/src/README".
...
For further information, use DrScheme's `Help' menu, or run
bin/plt-help. Also, visit http://www.plt-scheme.org/.
