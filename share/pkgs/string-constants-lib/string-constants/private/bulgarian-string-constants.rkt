...
(module bulgarian-string-constants "string-constant-lang.rkt"
  ...
  (pls-fill-in-either-description-or-reproduce
   "Попълнете едно от полетата „Описание“ и „Стъпки за възпроизвеждане“.")
  ...
  (cs-n-varrefs "~a поя̀ви като присвоена променлива")
  ...
  (online-expansion-abnormal-termination-out-of-memory
   "Заместването на заден фон завърши с грешка (паметта свърши)")
  ...
  (editor-changed-since-srcloc-recorded
   "Има промѐни в редактора след запазването на последното местоположение в изходния код."
   " Оцветената област може да не отговаря на правилното местоположение в изходния код.")
  ...
  (parenthesis-color-scheme "Цветова схема за скобите")
  ...
  (plt:hd:help-desk-about-string
   "Ръководството е изчерпателният източник на информация за програмите в"
  ...
  (plt:hd:help-on-help-details
   ...
   " (За да отворите въпросната начална страница, натиснете бутона „Начална страница“"
   " в горната част на прозореца за помощта.)")
  (reload "Презареждане") ;; refresh the page in a web browser
  (plt:hd:ask-about-separate-browser
   "Искате да отворите съдържание от световната мрежа."
   " Къде искате то да се визуализира —"
   " в браузъра за помощта или в отдѐлен браузър?")
  ...
  (help-desk-this-is-just-example-text
   "Това е примерен текст, за да изберете подходящ шрифт и размер."
   " Отворете „Ръководство“-то от менюто „Помощ“, за да отворите връзките.")
  ...
  (help-desk-materialize-docs-something-changed
   "DrRacket установи проблем с индекса на документацията."
   " Да се пробва ли поправка? Това може да отнеме известно"
  ...
  (help-desk-materialize-docs-first-time
   ...
   " досега документацията и търсенето чрез браузър ще е"
   " неуспешно.")
  ...
  (install-plt-error-downloading "Грешка при изтеглянето на"
                                 " файл „.plt“.\n\nДопълнителна информация:\n")
  (install-plt-error-header
   "Грешка при проверката на изтегления файл „.plt“."
   " Проверете адреса и опитайте отново.")
  ...
  (steal-the-lock-and-retry "Присвояване на &заключването и нов опит")
  ...
  (prefs-file-locked "Файлът с настройките е заключен (заключващият файл „~a“ е налице)."
  " Настройката не може да се запази. Да се отмени ли промяната?")
  ...
  (prefs-file-still-locked "Файлът с настройките е заключен (заключващият файл „~a“ е налице)."
   " Настройката не може да се запази.")
  ...
  (show-line-and-column-numbers "Показване на &номерата на редовете и колоните")
  ; used for popup menu; right click on line/column box in bottom of drs window
  (show-character-offsets "Показване на отместването в знаци")
  ...
  (interactions-beside-definitions "Прозорецът-скицник да е до прозореца с дефинициите")
  (show-line-numbers "Номера̀ на редовете")
  ;; just like the above, but capitalized for appearance in a menu item
  (show-line-numbers/menu "&Номера̀ на редовете")
  (hide-line-numbers/menu "&Без номера̀ на редовете")
  ...
  (editor-x-selection-mode "Изрично копиране преди поставяне, без"
                           " автоматично копиране на избраното")
  ...
  (pref-lock-not-gone
   ...
   " Ако сте сигурни, че в момента няма други процеси на Racket, можете да изтриете този файл.")
  ...
  (mfs-drscheme-multi-file-search-title "Търсене на „~a“ в много файлове — DrRacket")
  ...
  ;; this is the name of the "Windows" menu under linux & windows
  (tabs-menu "Подпрозорци")
  ...
  (no-completions "… няма подходящо дописване")
  ...
  (user-defined-keybinding-malformed-file
   "Файлът „~a“ не отговаря на езика за клавишни комбинации „framework/keybinding-lang“.")
  ...
  ;; first is a filename, second is an error message from mz.
  ...
  (definitions-modified
    "Файлът с дефинициите е променян във файловата система — или го запазете,"
    " или го възстановете от диска.")
  ...
  ;;; tools
  (invalid-tool-spec
  "Неправилно описание на инструмент във файла „info.rkt“ на колекцията „~a“."
  " Очаква се или низ, или непразен списък от низове, а не „~e“")
  ...
  (tool-tool-names-same-length
   "списъците „tool-names“ и „tools“ трябва да са с еднаква дължина, а във файла"
   " „info.rkt“ за „~s“ за бяха получени съответно ~e и ~e")
  (tool-tool-icons-same-length
  "списъците „tool-icons“ и „tools“ трябва да са с еднаква дължина, а във файла"
  " „info.rkt“ за „~s“ за бяха получени съответно ~e и ~e")
  (tool-tool-urls-same-length
  "списъците „tool-urls“ и „tools“ трябва да са с еднаква дължина, а във файла"
  " „info.rkt“ за „~s“ за бяха получени съответно ~e и ~e")
  ...
  (tool-config-changes
   "Промените в настройките ще влязат в сила при следващото стартиране на DrRacket.")
  ...
  (define-menu-configure "Настройки") ;; label of a submenu to configure the (define ...) popup menu
  ...
  (error-creating-executable "Грешка при създаването на изпълним файл:")

  (definitions-not-saved
    "Прозорецът с дефинициите не е запазен. Изпълнимият файл ще е базиран на"
    " последния записан вариант. Да се продължи ли?")
  ...
  (insert-number/bad-numerator
   "Числителят трябва да е неотрицателно, цяло число")
  (insert-number/bad-denominator
   "Числителят трябва да е положително, цяло число")
  ...
  (teachpacks-only-in-languages
   "Менюто за учебни модули е налично само за следните езици: ~a\n\nПри"
   " друг език — използвайте „require“.")
  ...
  (racket-dialect-in-buffer-message
   "Диалектите на „Racket“ най-често се избират чрез директно редактиране на буфера,"
   " а не чрез този диалогов прозорец.")
  (racket-dialect-add-new-#lang-line
   "Да се добави ли „~a“ в началото на прозореца с дефиниции?")
  (racket-dialect-replace-#lang-line
   "Директивата в буфера е „~a“. Да се замени ли с „~a“?")
  (racket-dialect-already-same-#lang-line
   "Директивата в буфера вече е „~a“"
   " и можете да започнете да програмирате.")
  ...
  (profiling-no-information-available
   "Липсва информация от профилиране. Проверете дали сте включили"
   " профилирането за езика си и дали сте изпълнявали програмата след това.")
  (profiling-clear?
  " Промяна в прозореца за дефиниции прави информацията от профилирането недействителна. Да се продължи ли въпреки това?")
  ...
  (tracing-tracing-nothing-to-show
   "Няма резултати от трасиране. За да се появят, ползваният език трябва да"
   " поддържа трасиране, а и самото то трябва да е включено.")

  ;;; repl stuff
  (evaluation-terminated "Прекъснато изчисление")
  (evaluation-terminated-explanation
   "Нишката за изчисления не работи. Чак при следващото"
   " изпълнение изчисленията ще започнат отново.")
  ...
  (module-browser-no-file "Преглед на модулите на този запазен файл")
  ...
  (module-browser-show-lib-paths/short "Следване на изисканите библиотеки")
  ;; check box label in show module browser pane in drscheme window.
  (module-browser-show-planet-paths/short "Следване на изисканото от PLaneT")
  ...
  (stepper-out-of-steps
   "Изчисляването свърши, преди да се открие стъпката, която търсите.")
  ...
  (program-has-open-windows
   "Програмата от прозореца с дефиниции все още има отворени прозорци. Затваряне на прозореца въпреки това?")
  ...
  (profj-intermediate-access-lang-one-line-summary
   "Език подобен на Java с указване на достъп за междинно ниво")
  ...
  (profj-language-config-testing-preferences "Мостра на настройките")
  ; Run should be the word found on the Run button
  ;(profj-language-config-testing-enable "Да се изведат ли резултатите от тестовете при „Изпълнение“?")
  ...
  (test-engine-enable-disable-tests-only-in-teaching-languages
   "Менюто за включване/изключване на тестовете се отнася само до езиците за обучение — „HtDP“"
   " и „DMdA“. Вижте раздела с подробностите от прозореца за езици, с който се определят модулите,"
   " които да се изпълнят в езика Racket.")
  ...
  (spell-program-did-not-respond-after-some-seconds
   "Програмата за правописа „~a“ не отговаря ~a секунди")
  ...
  (install-pkg-package-source-desc
   "Източникът на пакета е име, файл, директория, адрес в Интернет или връзка към GitHub")
  ...
  (install-pkg-really-remove-installation
   "Сигурни ли сте, че искате да изтриете всички пакети и информация в „~a“?")
  ...
  (install-pkg-dependencies-force
   "Форсиране: инсталиране, независимо липсващи или несъвпадащи по версия зависимости")
  (install-pkg-dependencies-search-ask
   "Питане: питане при всяка липсваща зависимост (не се поддържа в графичен режим)")
  (install-pkg-dependencies-search-auto
   "Автоматично: автоматично инсталиране на липсващите зависимости и версии")
  (install-pkg-dependencies-search-auto+update
   "Автоматично и обновяване: обновяване на всички възможни зависимости")
